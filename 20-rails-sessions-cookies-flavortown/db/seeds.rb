Nacho.create!([{
                ...
                name: 'dessert nachos',
                description: 'extra cheese nachos topped with deep fried oreos and tempura ice cream',
                price: 5
              }, {
                name: 'deluxe nachos',
                description: '15 year old aged gruyere cheese, gold flakes, truffle oil, wagyu beef, served atop free range non GMO organic corn chips rolled by hand in Machu Pichu',
                price: 75
              }])
