...
- What is a migration?
 - Ruby code that allows you to alter the database
Some ruby code that alters our schema
- What is a schema? The structure of our database
- to get our database set up, we need to use the
  `rake db:create_migration`

`rake db:create_migration NAME=create_boxers`
- TABLES ARE PLURAL
- check out the migrations in the `db/migrations` folder

Inherits from ACTIVE RECORD -- Time stamp
...
- Check all the methods Active record gives us!
